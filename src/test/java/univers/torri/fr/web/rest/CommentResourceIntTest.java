...
import univers.torri.fr.repository.CommentRepository;
import univers.torri.fr.service.CommentService;
import univers.torri.fr.service.dto.CommentDTO;
import univers.torri.fr.service.mapper.CommentMapper;
...
public class CommentResourceIntTest {
    ...
    public void createComment() throws Exception {
        ...
        assertThat(testComment.getPseudo()).isEqualTo(DEFAULT_PSEUDO);
    ...
    public void updateComment() throws Exception {
        ...
        assertThat(testComment.getPseudo()).isEqualTo(UPDATED_PSEUDO);
